...
function page() {
  return (
    <>
      <section className="privacyPolicy width100 flex alignCenter justifyCenter flexColumn">
        <div className="privacyPolicyContainer ">
          <h1>Privacy Policy for Campus Sutras</h1>
          <BigDivider />
          <p>
          ...
          <div className="ppcontainershort">
            <ul>
              <li>
              ...
              <li>
                ...
                "Us" or "Our" in this Agreement) refers to Campus Sutras Private
                Limited, 201309, Noida, India.
              </li>
              <li>
              ...
              <li>
                <span>Website</span> refers to Campus Sutras, accessible from{" "}
                <a href="https://campussutras.com">https://campussutras.com</a>
              </li>
              <li>
          ...
          <div className="ppcontainershort">
            <ul>
              ...
              <li>
                <span>For business transfers:</span> We may use Your information
          ...
          <div className="ppcontainershort">
            <ul>
              <li>By email: info@campussutras.com</li>
              <li>
                By visiting this page on our website:{" "}
                <a href="https://campussutras.com/contact">
                  https://campussutras.com/contact
                </a>
              </li>
              <li>By phone number: 9818218573</li>
            </ul>
          </div>
        </div>
      </section>
