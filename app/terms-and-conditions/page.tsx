...
function page() {
  return (
    <>
      <section className="termsConditions width100 flex alignCenter justifyCenter flexColumn">
        <div className="termsConditionsContainer">
          <h1>Terms and Conditions</h1>
          <BigDivider />
          <p>Welcome to Campus Sutras!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Campus Sutras Private Limited's Website, located at
            https://campussutras.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Campus Sutras if you do not agree
          ...
          <p>
            We employ the use of cookies. By accessing Campus Sutras, you agreed
            to use cookies in agreement with the Campus Sutras Private Limited's
            Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Campus Sutras Private Limited and/or its
            licensors own the intellectual property rights for all material on
            Campus Sutras. All intellectual property rights are reserved. You
            may access this from Campus Sutras for your own personal use
            subjected to restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <div className="tccontainershort">
            <ul>
              <li>Republish material from Campus Sutras</li>
              <li>Sell, rent or sub-license material from Campus Sutras</li>
              <li>Reproduce, duplicate or copy material from Campus Sutras</li>
              <li>Redistribute content from Campus Sutras</li>
            </ul>
          </div>
          <p>
          ...
          <p>
            ...
            Campus Sutras Private Limited does not filter, edit, publish or
            review Comments prior to their presence on the website. Comments do
            not reflect the views and opinions of Campus Sutras Private
            ...
            extent permitted by applicable laws, Campus Sutras Private Limited
          ...
          <p>
            Campus Sutras Private Limited reserves the right to monitor all
          ...
          <p>
            You hereby grant Campus Sutras Private Limited a non-exclusive
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Campus Sutras
          ...
          <p>
            ...
            sending an e-mail to Campus Sutras Private Limited. Please include
          ...
          <p>
            No use of Campus Sutras Private Limited's logo or other artwork will
